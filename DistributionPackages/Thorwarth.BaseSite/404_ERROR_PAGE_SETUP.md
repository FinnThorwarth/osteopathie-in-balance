# 404-Fehlerseite Setup für Thorwarth.BaseSite

## Übersicht

Diese Dokumentation beschreibt die implementierte 404-Fehlerseite für das Thorwarth.BaseSite Neos 9 Projekt.
        ...
        errorHandling:
          'Neos\Flow\Mvc\Exception\NoMatchingRouteException':
            renderingGroups:
              'Neos.Neos:Fallback':
                options:
                  templatePathAndFilename: 'resource://Thorwarth.BaseSite/Private/Templates/Error/404.html'
                  variables:
                    errorCode: 404
...
'Neos\Flow\Http\Exception\ServiceUnavailableException':
  renderingGroups:
    'Neos.Neos:Fallback':
      options:
        templatePathAndFilename: 'resource://Thorwarth.BaseSite/Private/Templates/Error/503.html'
        variables:
          errorCode: 503
